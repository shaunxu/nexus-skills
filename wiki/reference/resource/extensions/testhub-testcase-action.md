---
title: "测试用例 - 详情菜单"
lastUpdated: 2026-07-15T16:25:39.000Z
---

# 测试用例 - 详情菜单

测试用例详情页菜单扩展模块，允许在测试用例详情页的更多操作中扩展模块：

![测试用例｜详情菜单.png](../../../assets/20c95daf310e1494061478814f0437cd7d79a65d.png)
...
```yaml
extensions:
  - key: example-testcase-action
    target: "pcm:testhub:testcase:action"
    title: Action title
...
<table style="width: 100%; table-layout: fixed"><colgroup><col style="width: 16.24%" /><col style="width: 16.95%" /><col style="width: 11.72%" /><col style="width: 55.09%" /></colgroup><thead><tr><th>属性</th><th>类型</th><th>必填</th><th>描述</th></tr></thead><tbody><tr><td><code>title</code></td><td><code>string ｜ i18n</code></td><td>Y</td><td>定义扩展模块的分组标题</td></tr><tr><td><code>icon</code></td><td><code>string</code></td><td></td><td>定义扩展模块的菜单项的图标</td></tr><tr><td><code>resource</code></td><td><code>string</code></td><td>Y</td><td>定义扩展模块所使用的资源，内容为 <code>resources</code> 节点的资源引用</td></tr><tr><td><code>resolver</code></td><td><code>{ function: string }</code>  或 <code>{ endpoint: string }</code></td><td>Y</td><td>定义扩展模块所使用的处理函数： - 指定后端处理函数时使用 <code>function</code> 属性 - 指定远程服务时使用 <code>endpoint</code> 属性</td></tr><tr><td><code>type</code></td><td><code>string</code></td><td></td><td>定义扩展模块的菜单项的类型</td></tr><tr><td><code>behavior</code></td><td><code>string</code></td><td></td><td>定义扩展模块的菜单项的行为</td></tr><tr><td><code>viewport</code></td><td><code>object</code></td><td></td><td>定义扩展模块弹窗的尺寸，当弹出行为是 <code>behavior</code> 时，可设置弹窗尺寸</td></tr><tr><td><code>viewport·size</code></td><td><code>string</code></td><td></td><td>定义扩展模块的高度，默认高度自适应，可选 <code>small</code> , <code>medium</code> , <code>large</code> , <code>xlarge</code> , <code>max</code> , <code>fullscreen</code></td></tr></tbody></table>
