---
title: "项目 - 设置页面"
lastUpdated: 2026-07-15T16:23:10.000Z
---

# 项目 - 设置页面

项目设置页面扩展模块，允许在项目设置中添加自定义扩展页面，该页面的访问地址为：

`/pjm/projects/{identifier}/settings/apps/{appId}/{envId}/{route}`

![image.png](../../../assets/ae0809ac7b4e54708f8c84e82432346ec9ea3629.png)
...
```yaml
extensions:
  - key: example-project-setting
    target: "pcm:pjm:project:setting"
    resolver:
      function: resolver
    pages:
      - key: example-page
