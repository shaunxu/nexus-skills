---
title: "产品 - 首页导航"
lastUpdated: 2026-07-30T08:42:05.000Z
---

# 产品 - 首页导航

产品首页扩展模块，允许在产品首页左侧添加自定义组件页面，扩展模块支持自定义分组名称，该页面的访问地址为：

`/ship/apps/{appId}/{envId}/{route}`

![产品｜首页导航.png](../../../assets/9f87fa8382c1ed659e69fa8834a61e6ba3fda2af.png)
...
```yaml
extensions:
  - key: example-product-hub
    target: "pcm:ship:product:hub"
    resolver:
      function: resolver
    pages:
      - key: example-page
