---
title: "空间 - 空间设置"
lastUpdated: 2026-07-30T08:46:04.000Z
---

# 空间 - 空间设置

空间设置页面扩展模块，允许在空间设置中添加自定义扩展页面，扩展模块支持自定义分组名称，该页面的访问地址为：

`/wiki/spaces/{identifier}/settings/apps/{appId}/{envId}/{toute}`

![空间｜空间设置.png](../../../assets/847a82eb40df30010fbb589aaec4e6ae8c4be6ac.png)
...
```yaml
extensions:
  - key: example-space-setting
    target: "pcm:wiki:space:setting"
    resolver:
      function: resolver
    pages:
      - key: example-page
