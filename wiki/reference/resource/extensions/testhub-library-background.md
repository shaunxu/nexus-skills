---
title: "测试库 - 首页后台脚本"
lastUpdated: 2026-07-15T16:25:21.000Z
---

# 测试库 - 首页后台脚本

允许在测试库首页增加后台脚本，支持统一处理数据、状态和事件逻辑
...
```yaml
extensions:
    - key: example-library-background
      target: "pcm:testhub:library:background"
      resource: main
```
...
<table style="width: 100%; table-layout: fixed"><colgroup><col style="width: 27.54%" /><col style="width: 72.46%" /></colgroup><thead><tr><th>数据</th><th>说明</th></tr></thead><tbody><tr><td>无</td><td></td></tr></tbody></table>
