---
title: "测试用例 - 详情上下文"
lastUpdated: 2026-07-15T16:25:35.000Z
---

# 测试用例 - 详情上下文

测试用例详情页上下文扩展模块，允许在测试用例详情页右侧增加扩展模块：

![测试用例｜详情上下文.png](../../../assets/507c9f8a46ea9cddca7f801dc132ce9938f8f583.png)
...
```yaml
extensions:
  - key: example-testcase-context
    target: "pcm:testhub:testcase:context"
    title: Group title
    viewportsize: medium
    resource: main
    resolver:
