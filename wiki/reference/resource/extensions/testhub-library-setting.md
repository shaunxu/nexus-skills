---
title: "测试库 - 设置页面"
lastUpdated: 2026-07-15T16:25:16.000Z
---

# 测试库 - 设置页面

测试库设置页面扩展模块，允许在测试库设置中添加自定义扩展页面，该页面的访问地址为：

`/testhub/libraries/{identifier}/settings/apps/{appId}/{envId}/{route}`

![测试｜测试设置.png](../../../assets/efa1d6e26e4512915f2e0577208604c51a699711.png)
...
```yaml
extensions:
  - key: example-library-setting
    target: "pcm:testhub:library:setting"
    resolver:
      function: resolver
    pages:
      - key: example-page
