---
title: "测试用例 - 详情导航"
lastUpdated: 2026-07-15T16:25:26.000Z
---

# 测试用例 - 详情导航

测试用例详情导航扩展模块，允许在测试用例详情页面导航中添加自定义页面：

![测试用例｜详情导航.png](../../../assets/033e4bca820defeaff277bedd9b0cfb32b86782d.png)
...
```yaml
extensions:
  - key: example-testcase-area
    target: "pcm:testhub:testcase:area"
    title: Area title
    resource: main
    resolver:
      function: resolver
