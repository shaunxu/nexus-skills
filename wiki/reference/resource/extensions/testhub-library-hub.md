---
title: "测试库 - 首页导航"
lastUpdated: 2026-07-15T16:25:06.000Z
---

# 测试库 - 首页导航

测试库首页导航扩展模块，允许在测试库首页导航中添加自定义分组和页面，扩展模块支持自定义分组名称，该页面的访问地址为：

`/testhub/libraries/apps/{appId}/{envId}/{route}`

![测试首页.png](../../../assets/1bd10eb173f0e2b7593c5e26cd0864e865b29172.png)
...
```yaml
extensions:
  - key: example-library-hub
    target: "pcm:testhub:library:hub"
    resolver:
      function: resolver
    pages:
      - key: example-page
