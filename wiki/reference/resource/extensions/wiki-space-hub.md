---
title: "空间 - 首页导航"
lastUpdated: 2026-07-30T08:48:14.000Z
---

# 空间 - 首页导航

空间首页扩展模块，允许在首页左侧添加自定义组件页面，扩展模块支持自定义分组名称，该页面的访问地址为：

`/wiki/apps/{appId}/{envId}/{route}`

![空间｜首页导航.png](../../../assets/6dc1d2e00c8580452151a91864ec07fdf2515346.png)
...
```yaml
extensions:
  - key: example-space-hub
    target: "pcm:wiki:space:hub"
    resolver:
      function: resolver
    pages:
      - key: example-page
